...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = PreprPhoto.class, name = "Photo"),
    @JsonSubTypes.Type(value = PreprVideo.class, name = "Video"),
    @JsonSubTypes.Type(value = PreprAudio.class, name = "Audio"),
    @JsonSubTypes.Type(value = PreprCover.class, name = "Cover"),
    @JsonSubTypes.Type(value = PreprPost.class, name = "Post"),
    ...
    @JsonSubTypes.Type(value = PreprTrackPlay.class, name = "TrackPlay"),
    ...
    @JsonSubTypes.Type(value = PreprTalk.class, name = "Talk"),
    @JsonSubTypes.Type(value = PreprTrafficTalk.class, name = "TrafficTalk"),
    @JsonSubTypes.Type(value = PreprWeatherTalk.class, name = "WeatherTalk"),
    @JsonSubTypes.Type(value = PreprCommercial.class, name = "Commercial"),
