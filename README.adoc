...
This was created because https://rs.poms.omroep.nl/v1[POMS] (at the moment a future version of it) sychronizes data from prepr for radio related data of the dutch public broadcasters
