...
image:https://github.com/vpro/prepr/workflows/build/badge.svg?[Build Status,link=https://github.com/vpro/vpro-shared/actions?query=workflow%3Abuild]
...
image:https://codecov.io/gh/vpro/prepr/branch/master/graph/badge.svg[codecov,link=https://codecov.io/gh/vpro/prepr]e
